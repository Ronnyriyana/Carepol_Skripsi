								...
								<tr>
									...
									<div class="dropdown">
										...
										<ul class="dropdown-menu">
										  <li><a href="<?php echo base_url('index.php/adminxuser/detail_user/').$data['id_pengelola']; ?>">Detail</a></li>
										  <li><a href="<?php echo base_url('index.php/adminxuser/edit_user/').$data['id_pengelola']; ?>">Edit</a></li>
										  <li><a href="<?php echo base_url('index.php/adminxuser/proses_delete/').$data['id_pengelola']; ?>"  data-toggle="confirmation" data-placement="left" data-popout="true">Delete</a></li>
										</ul>
									</div>
									</td>
								</tr>
